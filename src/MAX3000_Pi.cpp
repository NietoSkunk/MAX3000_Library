...
size_t Stream::print(unsigned char b, int base)
{
  return print((unsigned long) b, base);
}

size_t Stream::print(int n, int base)
{
  return print((long) n, base);
}

size_t Stream::print(unsigned int n, int base)
{
  return print((unsigned long) n, base);
}

size_t Stream::print(long n, int base)
{
  if (base == 0) {
    return write(n);
  } else if (base == 10) {
...
size_t Stream::print(unsigned long n, int base)
{
  if (base == 0) return write(n);
  else return printNumber(n, base);
}

size_t Stream::print(double n, int digits)
{
...
size_t Stream::println(const char c[])
{
  size_t n = print(c);
  n += println();
  return n;
...
size_t Stream::println(unsigned char b, int base)
{
...
size_t Stream::printNumber(unsigned long n, uint8_t base)
{
...
size_t Stream::printFloat(double number, uint8_t digits) 
{ 
  size_t n = 0;
